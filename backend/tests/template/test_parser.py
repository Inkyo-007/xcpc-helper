...
def test_missing_title_produces_error() -> None:
    meta, _, diags = _parse("---\ntags: [a]\n---\n")
    assert meta.title is None
    assert any(d.level == "error" and "title" in d.message for d in diags)
